...
export default function Main({ children, openSidebar }) {
  ...
  const banner = 'this is a demo version of Ohmakase.';
  ...
  return (
    <div className="flex flex-1 flex-col md:pl-64">
      <div className="sticky top-0 z-10 md:hidden px-0.5 flex text-white justify-center items-center bg-lime-500 text-sm">
        {banner}
      </div>
      <div className="sticky top-[20px] z-10 bg-lisbon-500 text-lisbon-50 px-1 sm:pl-3 sm:py-1.5 flex items-center relative justify-between md:hidden">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-0.5 hidden md:flex text-white justify-center items-center bg-lime-500 mb-2">
          {banner}
        </div>
        <div className="py-6">
